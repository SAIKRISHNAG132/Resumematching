...
def update_match_scores():
    """Fetch resumes & jobs, use Gemini API for matching, and update MongoDB (jobs collection)."""
    ...
    for job in jobs:
        ...
        updated_jobs.append({"job_id": str(job_id), "match_percentages": job["match_percentages"]}) #Convert job_id to string.
